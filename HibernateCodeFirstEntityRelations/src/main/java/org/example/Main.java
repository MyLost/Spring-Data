...
/*
    ...
    First Task for gringotts not require relations, but relation are used in this example!
 */

public class Main {
    public static void main(String[] args) {

        EntityManager entityManager = new Connection("example-sales").getEntityManager();
